        ...
        >
            ...
            <div className="grid grid-cols-1 gap-3">
                ...
                <input
                    ...
                    placeholder="E.g. Food, Orange Juice, Salad, Exercise, Gym, Bicycle"
                    value={activity.name}
                    onChange={handleChange}
                />
            </div>
            ...
            <input
                type="submit"
                className="bg-gray-800 w-full p-2 font-bold text-white uppercase cursor-pointer transition-all duration-200 hover:bg-gray-700 active:bg-gray-900 disabled:opacity-20 disabled:cursor-auto disabled:hover:bg-gray-800"
